...
func flagBindings() []flagBinding {
	return []flagBinding{
		...
		{Name: "install-file-association", Usage: "Associate .spsq files and add .sbg conversion (Windows only)", ValueKind: flagValueBool, BindBool: func(opts *CLIOptions) *bool { return &opts.InstallFileAssociation }, SpecialCommand: SpecialCommandInstallFileAssociation},
		{Name: "uninstall-file-association", Usage: "Remove .spsq association and .sbg conversion (Windows only)", ValueKind: flagValueBool, BindBool: func(opts *CLIOptions) *bool { return &opts.UninstallFileAssociation }, SpecialCommand: SpecialCommandUninstallFileAssociation},
