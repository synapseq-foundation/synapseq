...
var completionFlags = map[string]string{
	...
	"ai":                         "Generate an SPSQ sequence from a prompt",
	"ai-model":                   "OpenAI-compatible model for AI generation",
	"ai-base-url":                "OpenAI-compatible API host for AI generation",
	"ai-provider":                "Provider compatibility mode for AI generation",
	"ai-temperature":             "Sampling temperature for AI generation",
	"ai-timeout":                 "Maximum duration for AI generation",
