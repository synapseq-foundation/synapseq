...
func TestBuildTrackFromDeclaration_Success(ts *testing.T) {
	tests := []struct {
		...
		{line: "tone 300 effect shift 10 intensity 25 amplitude 20", want: t.Track{Type: t.TrackPureTone, Carrier: 300, Amplitude: t.AmplitudePercentToRaw(20), Waveform: t.WaveformSine, Effect: t.Effect{Type: t.EffectShift, Value: 10, Intensity: t.IntensityPercentToRaw(25)}}},
		{line: "tone 300 binaural 8 effect shift 4 intensity 20 amplitude 20", want: t.Track{Type: t.TrackBinauralBeat, Carrier: 300, Resonance: 8, Amplitude: t.AmplitudePercentToRaw(20), Waveform: t.WaveformSine, Effect: t.Effect{Type: t.EffectShift, Value: 4, Intensity: t.IntensityPercentToRaw(20)}}},
		...
		{line: "noise pink smooth 30 effect shift 8 intensity 20 amplitude 20", want: t.Track{Type: t.TrackPinkNoise, NoiseSmooth: 30, Amplitude: t.AmplitudePercentToRaw(20), Waveform: t.WaveformSine, Effect: t.Effect{Type: t.EffectShift, Value: 8, Intensity: t.IntensityPercentToRaw(20)}}},
