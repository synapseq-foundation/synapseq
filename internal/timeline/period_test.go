...
func TestAdjustPeriods_CreatesBoundaryCrossfades(ts *testing.T) {
	...
	tests := []struct {
		...
		{"change effect type while on", t.Track{Type: t.TrackAmbiance, SourceName: "rain", Amplitude: t.AmplitudePercentToRaw(20), Waveform: t.WaveformSine, Effect: t.Effect{Type: t.EffectPan}}, t.Track{Type: t.TrackAmbiance, SourceName: "rain", Amplitude: t.AmplitudePercentToRaw(20), Waveform: t.WaveformSine, Effect: t.Effect{Type: t.EffectPan}}, t.Track{Type: t.TrackAmbiance, SourceName: "rain", Amplitude: t.AmplitudePercentToRaw(25), Waveform: t.WaveformSine, Effect: t.Effect{Type: t.EffectModulation}}, true, true},
		{"change ambiance while on", t.Track{Type: t.TrackAmbiance, SourceName: "rain", Amplitude: t.AmplitudePercentToRaw(20), Waveform: t.WaveformSine}, t.Track{Type: t.TrackAmbiance, SourceName: "rain", Amplitude: t.AmplitudePercentToRaw(20), Waveform: t.WaveformSine}, t.Track{Type: t.TrackAmbiance, SourceName: "river", Amplitude: t.AmplitudePercentToRaw(25), Waveform: t.WaveformSine}, true, true},
		{"change music while on", t.Track{Type: t.TrackMusic, SourceName: "meditation", Amplitude: t.AmplitudePercentToRaw(20), Waveform: t.WaveformSine}, t.Track{Type: t.TrackMusic, SourceName: "meditation", Amplitude: t.AmplitudePercentToRaw(20), Waveform: t.WaveformSine}, t.Track{Type: t.TrackMusic, SourceName: "bells", Amplitude: t.AmplitudePercentToRaw(25), Waveform: t.WaveformSine}, true, true},
		{"change music to tone while on", t.Track{Type: t.TrackMusic, SourceName: "meditation", Amplitude: t.AmplitudePercentToRaw(20), Waveform: t.WaveformSine}, t.Track{Type: t.TrackMusic, SourceName: "meditation", Amplitude: t.AmplitudePercentToRaw(20), Waveform: t.WaveformSine}, t.Track{Type: t.TrackPureTone, Carrier: 200, Amplitude: t.AmplitudePercentToRaw(25), Waveform: t.WaveformSine}, true, true},
		{"change tone to music while on", t.Track{Type: t.TrackPureTone, Carrier: 200, Amplitude: t.AmplitudePercentToRaw(20), Waveform: t.WaveformSine}, t.Track{Type: t.TrackPureTone, Carrier: 200, Amplitude: t.AmplitudePercentToRaw(20), Waveform: t.WaveformSine}, t.Track{Type: t.TrackMusic, SourceName: "bells", Amplitude: t.AmplitudePercentToRaw(25), Waveform: t.WaveformSine}, true, true},
	}
