...
If you prefer to install manually, download the appropriate archive from the latest GitHub release: [v4.1.1](https://github.com/synapseq-foundation/synapseq/releases/tag/v4.1.1).
