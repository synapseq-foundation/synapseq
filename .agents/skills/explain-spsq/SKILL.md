...
4. Explain the sequence in this order:
   ...
   - what each track contributes: source, rhythm or beat, waveform, left/right amplitude when asymmetric, smoothness, and effects, including waveform-shaped doppler motion and mono-derived external-audio shift;
...
- Describe binaural, monaural, isochronic, noise, modulation, shift, spatial movement, and transitions as audio behavior. Distinguish external-audio `shift` from a generated binaural beat.
