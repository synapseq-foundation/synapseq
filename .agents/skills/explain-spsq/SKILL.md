...
4. Explain the sequence in this order:
   ...
   - what each track contributes: source, rhythm or beat, waveform, left/right amplitude when asymmetric, smoothness, and effects, including waveform-shaped Doppler pitch or playback-speed motion and mono-derived shift;
